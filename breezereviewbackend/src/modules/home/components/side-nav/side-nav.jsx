...
export default class SideNav extends React.Component {
    ...
    render() {
        return (
            <div>
                <div className="w3-container w3-top w3-black w3-large w3-padding" style={{ zIndex: "4" }}>
                    <button className="w3-btn w3-hide-large w3-padding-0 w3-hover-text-grey" onClick={w3_open}><i className="fa fa-bars"></i>  Menu</button>
