...
export default class Login extends React.Component {
  ...
  handleChange = (event) => {
    ...
    switch (name) {
      case "username":
        newform.username =
          emailReg.test(value) && value.length > 0 ? "" : "Email not valid";
        break;
  ...
  render() {
    return (
      <div
        ...
        style={{ maxWidth: "400px", marginTop: "20vh" }}
      >
            ...
            <input
              className={
                this.state.formErrors.username.length > 0
                  ? "w3-input w3-border w3-margin-bottom w3-border-red"
                  : "w3-input w3-border w3-margin-bottom"
              }
              type="text"
